...
class ModEstudiante(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_titulo = wx.StaticText(self, -1, "Modificación de estudiante")
    ...
    def __set_properties(self):
        # begin wxGlade: ModEstudiante.__set_properties
        self.SetTitle(u"Modificación de Estudiante")
        ...
        if q[18] == '0':
            ...
            hasta = u'Completo'
        self.combo_box_anio.SetValue(u'%s' % hasta)
